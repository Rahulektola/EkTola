 ...
 */
import { checkAdminAuth, AdminNavigation, formatNumber, formatPercentage, apiRequest } from './admin-common.js';
...
async function loadAnalytics() {
    ...
    try {
        const data = await apiRequest(`/analytics/admin/detailed?days=${currentDays}`, authService);
 ...
 */
function renderCampaignTypeChart(types) {
 ...
 */
function renderFailureChart(failures) {
