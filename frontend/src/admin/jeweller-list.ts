 ...
 */
window.viewJeweller = function(id: number): void {
 ...
 * Approve jeweller
 */
window.approveJeweller = async function(id: number): Promise<void> {
 ...
 * Delete jeweller
 */
window.deleteJeweller = async function(id: number, businessName: string): Promise<void> {
    const confirmed = await new ConfirmationModal(
        'Delete Jeweller',
